...
# ╔═╡ 2d51fc3e-5d86-404c-836f-d4384edd53f9
ajuste_alg(D[1])
...
# ╔═╡ 77f3b552-cab7-4694-898a-5888712a96f7
begin 
	#circImpli(x,y,a,b,c) =  x^2 + y^2 -2*a*x -2*b*y -c
	function plot_algebraico(D)
		a,b,c = ajuste_alg(D)
		r = √(c+a^2+b^2)
